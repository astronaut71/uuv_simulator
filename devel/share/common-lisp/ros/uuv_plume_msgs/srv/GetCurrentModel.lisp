...
(cl:defmethod cl:initialize-instance :after ((m <GetCurrentModel-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetCurrentModel-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uuv_plume_msgs-srv:<GetCurrentModel-request> is deprecated: use uuv_plume_msgs-srv:GetCurrentModel-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetCurrentModel-request>)))
  ...
  "uuv_plume_msgs/GetCurrentModelRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetCurrentModel-request)))
  "Returns string type for a service object of type 'GetCurrentModel-request"
  "uuv_plume_msgs/GetCurrentModelRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetCurrentModel-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetCurrentModel-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uuv_plume_msgs-srv:<GetCurrentModel-response> is deprecated: use uuv_plume_msgs-srv:GetCurrentModel-response instead.")))

(cl:ensure-generic-function 'mean-val :lambda-list '(m))
(cl:defmethod mean-val ((m <GetCurrentModel-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uuv_plume_msgs-srv:mean-val is deprecated.  Use uuv_plume_msgs-srv:mean instead.")
  (mean m))

(cl:ensure-generic-function 'min-val :lambda-list '(m))
(cl:defmethod min-val ((m <GetCurrentModel-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uuv_plume_msgs-srv:min-val is deprecated.  Use uuv_plume_msgs-srv:min instead.")
  (min m))

(cl:ensure-generic-function 'max-val :lambda-list '(m))
(cl:defmethod max-val ((m <GetCurrentModel-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uuv_plume_msgs-srv:max-val is deprecated.  Use uuv_plume_msgs-srv:max instead.")
  (max m))

(cl:ensure-generic-function 'noise-val :lambda-list '(m))
(cl:defmethod noise-val ((m <GetCurrentModel-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uuv_plume_msgs-srv:noise-val is deprecated.  Use uuv_plume_msgs-srv:noise instead.")
  (noise m))

(cl:ensure-generic-function 'mu-val :lambda-list '(m))
(cl:defmethod mu-val ((m <GetCurrentModel-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uuv_plume_msgs-srv:mu-val is deprecated.  Use uuv_plume_msgs-srv:mu instead.")
  (mu m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetCurrentModel-response>)))
  ...
  "uuv_plume_msgs/GetCurrentModelResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetCurrentModel-response)))
  "Returns string type for a service object of type 'GetCurrentModel-response"
  "uuv_plume_msgs/GetCurrentModelResponse")
