...
void colorDetectionCallback(const sensor_msgs::ImageConstPtr& original_image)
{
   ...
   double x_target_normalized = double(m.m10/m.m00 -384)/384;
   double y_target_normalized = double(-m.m01/m.m00 +246)/246;
...
int main(int argc, char **argv)
{
    ...
    // String topic_address = namespace + "/camera/camera_image"
