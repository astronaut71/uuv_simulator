...
(cl:defmethod cl:initialize-instance :after ((m <SetCurrentVelocity-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetCurrentVelocity-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uuv_plume_msgs-srv:<SetCurrentVelocity-request> is deprecated: use uuv_plume_msgs-srv:SetCurrentVelocity-request instead.")))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <SetCurrentVelocity-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uuv_plume_msgs-srv:velocity-val is deprecated.  Use uuv_plume_msgs-srv:velocity instead.")
  (velocity m))
...
(cl:defmethod horizontal_angle-val ((m <SetCurrentVelocity-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uuv_plume_msgs-srv:horizontal_angle-val is deprecated.  Use uuv_plume_msgs-srv:horizontal_angle instead.")
  (horizontal_angle m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetCurrentVelocity-request>)))
  ...
  "uuv_plume_msgs/SetCurrentVelocityRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetCurrentVelocity-request)))
  "Returns string type for a service object of type 'SetCurrentVelocity-request"
  "uuv_plume_msgs/SetCurrentVelocityRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SetCurrentVelocity-request>)))
  ...
  "29979ce59631380ff17a987b6ff491eb")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SetCurrentVelocity-request)))
  "Returns md5sum for a message object of type 'SetCurrentVelocity-request"
  "29979ce59631380ff17a987b6ff491eb")
...
(cl:defmethod cl:initialize-instance :after ((m <SetCurrentVelocity-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetCurrentVelocity-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uuv_plume_msgs-srv:<SetCurrentVelocity-response> is deprecated: use uuv_plume_msgs-srv:SetCurrentVelocity-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetCurrentVelocity-response>)))
  ...
  "uuv_plume_msgs/SetCurrentVelocityResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetCurrentVelocity-response)))
  "Returns string type for a service object of type 'SetCurrentVelocity-response"
  "uuv_plume_msgs/SetCurrentVelocityResponse")
