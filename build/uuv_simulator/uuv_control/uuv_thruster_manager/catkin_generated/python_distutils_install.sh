...
echo_and_run cd "/home/bojan/uuv_simulator_ws/src/uuv_simulator/uuv_control/uuv_thruster_manager"
...
echo_and_run /usr/bin/env \
    ...
    "/home/bojan/uuv_simulator_ws/src/uuv_simulator/uuv_control/uuv_thruster_manager/setup.py" \
     \
    build --build-base "/home/bojan/uuv_simulator_ws/build/uuv_simulator/uuv_control/uuv_thruster_manager" \
    install \
    --root="${DESTDIR-/}" \
