...
echo_and_run cd "/home/bojan/uuv_simulator_ws/src/unique_identifier/unique_id"
...
echo_and_run /usr/bin/env \
    ...
    "/home/bojan/uuv_simulator_ws/src/unique_identifier/unique_id/setup.py" \
     \
    build --build-base "/home/bojan/uuv_simulator_ws/build/unique_identifier/unique_id" \
    install \
    --root="${DESTDIR-/}" \
