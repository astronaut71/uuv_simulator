...
echo_and_run cd "/home/bojan/uuv_simulator_ws/src/rotors_simulator/rotors_evaluation"
...
echo_and_run /usr/bin/env \
    ...
    "/home/bojan/uuv_simulator_ws/src/rotors_simulator/rotors_evaluation/setup.py" \
     \
    build --build-base "/home/bojan/uuv_simulator_ws/build/rotors_simulator/rotors_evaluation" \
    install \
    --root="${DESTDIR-/}" \
