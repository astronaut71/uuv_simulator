...
echo_and_run cd "/home/bojan/uuv_simulator_ws/src/uuv_plume_simulator/uuv_plume_simulator"
...
echo_and_run /usr/bin/env \
    ...
    "/home/bojan/uuv_simulator_ws/src/uuv_plume_simulator/uuv_plume_simulator/setup.py" \
     \
    build --build-base "/home/bojan/uuv_simulator_ws/build/uuv_plume_simulator/uuv_plume_simulator" \
    install \
    --root="${DESTDIR-/}" \
